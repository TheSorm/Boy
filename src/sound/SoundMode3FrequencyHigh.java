...
public class SoundMode3FrequencyHigh extends RamRegister
{
	private static final int LOAD_MASK = 0b1011_1111;

	private static final int NR34_ADRESS = 0xFF1E;
	...
	public SoundMode3FrequencyHigh(SoundOnOrOffRegister soundOnOrOffRegister)
	{
		super(NR34_ADRESS);
